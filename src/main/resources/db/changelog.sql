...
--changeset yourname:insert_test_data
INSERT INTO USERS (ID, DISPLAY_NAME, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, ENDPOINT, STARTPOINT)
VALUES (2, 'user2', 'user2@example.com', 'User', 'Two', '{noop}password', NULL, NULL)
ON CONFLICT (ID) DO NOTHING;

INSERT INTO PROJECT (ID, CODE, TITLE, DESCRIPTION, TYPE_CODE, STARTPOINT, ENDPOINT, PARENT_ID)
VALUES (1, 'TEST', 'Test Project', 'Test description', 'scrum', NULL, NULL, NULL)
ON CONFLICT (ID) DO NOTHING;

INSERT INTO SPRINT (ID, STATUS_CODE, STARTPOINT, ENDPOINT, CODE, PROJECT_ID)
VALUES (1, 'active', NULL, NULL, 'Sprint 1', 1)
ON CONFLICT (ID) DO NOTHING;

INSERT INTO TASK (ID, TITLE, TYPE_CODE, STATUS_CODE, PROJECT_ID, SPRINT_ID, PARENT_ID, STARTPOINT, ENDPOINT)
VALUES (1, 'Test Task', 'task', 'in_progress', 1, 1, NULL, NULL, NULL)
ON CONFLICT (ID) DO NOTHING;

--changeset anyname:add_time_activities
INSERT INTO ACTIVITY (AUTHOR_ID, TASK_ID, UPDATED, STATUS_CODE)
VALUES
    (2, 1, '2023-05-15 10:00:00', 'in_progress'),
    (2, 1, '2023-05-15 14:30:00', 'ready_for_review'),
    (2, 1, '2023-05-15 16:45:00', 'done');